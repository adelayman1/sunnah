const categories = [
    { id: "daily", name: "سنن اليوم والليلة", count: 11 },
    { id: "prayer", name: "سنن الصلاة", count: 7 },
    { id: "home", name: "سنن المنزل", count: 4 },
    { id: "social", name: "سنن التعامل", count: 4 },
    { id: "travel", name: "سنن السفر", count: 2 },
    { id: "occasions", name: "سنن المناسبات", count: 25 },
];
...
const sunnahs = [{
    ...
    },
    {
        ...
        category: "prayer",
        categoryName: "سنن الصلاة",
        summary: "عن أم المؤمنين عائشة رضي الله عنها أنَّ رَسولَ اللهِ صلَّى اللهُ عليه وسلَّم كانَ يقولُ في رُكوعِه وسُجودِه: سُبُّوحٌ قُدُّوسٌ، رَبُّ المَلائِكةِ والرُّوحِ",
        hasImage: true,
        thumb: "linear-gradient(135deg, #1e40af, #0f172a), radial-gradient(circle at 70% 20%, #60a5fa, transparent 35%)",
        excerpt: "مختصر افتتاحي يوضح السياق العام بطريقة مناسبة للقراءة السريعة.",
        fullText: "نص مثال للنص الكامل يوضع في هذا المكان. تمت المحافظة على بنية تسمح بإضافة نصوص أطول مستقبلًا دون تغيير التصميم.",
...
},
{
    ...
    category: "prayer",
    categoryName: "سنن الصلاة",
    summary: "عن أبي هريرة -رضي الله عنه- عن النبي صلى الله عليه وسلم قال إذا قام أحدكم من الليل فليفتتح صلاته بركعتين خفيفتين",
    hasImage: true,
    thumb: "linear-gradient(135deg, #1d4ed8, #0f172a), radial-gradient(circle at left top, #60a5fa, transparent 40%)",
    excerpt: "عن أبي هريرة -رضي الله عنه- عن النبي صلى الله عليه وسلم قال إذا قام أحدكم من الليل فليفتتح صلاته بركعتين خفيفتين",
...
},
{
    ...
    category: "daily",
    categoryName: "سنن اليوم والليلة",
    summary: "قال صلى الله عليه وسلم \"مَنْ بَاتَ وَفِي يَدِهِ رِيحُ غَمَرٍ، فَأَصَابَهُ شَيْءٌ، فَلاَ يَلُومَنَّ إِلاَّ نَفْسَهُ\"",
    hasImage: true,
    thumb: "linear-gradient(135deg, #1d4ed8, #020617), radial-gradient(circle at center, #93c5fd, transparent 30%)",
    excerpt: "قال صلى الله عليه وسلم \"مَنْ بَاتَ وَفِي يَدِهِ رِيحُ غَمَرٍ، فَأَصَابَهُ شَيْءٌ، فَلاَ يَلُومَنَّ إِلاَّ نَفْسَهُ\"",
...
},
{
    ...
    category: "daily",
    categoryName: "سنن اليوم والليلة",
    summary: "قال صلى الله عليه وسلم \"مَن تَصَبَّحَ كُلَّ يَومٍ سَبعَ تَمَراتٍ عَجوةً، لم يَضُرَّه في ذلك اليَومِ سُمٌّ ولا سِحرٌ\"",
    hasImage: true,
    thumb: "linear-gradient(135deg, #1d4ed8, #020617), radial-gradient(circle at center, #93c5fd, transparent 30%)",
    excerpt: "قال صلى الله عليه وسلم \"مَن تَصَبَّحَ كُلَّ يَومٍ سَبعَ تَمَراتٍ عَجوةً، لم يَضُرَّه في ذلك اليَومِ سُمٌّ ولا سِحرٌ\"",
